...
#pragma mark - YJYKinsfolksController

@interface YJYKinsfolksController ()
...
@implementation YJYKinsfolksController



+ (instancetype)instanceWithStoryBoard {
    
    return (YJYKinsfolksController *)[UIStoryboard storyboardWithName:@"YJYPerson" viewControllerIdentifier:@"YJYKinsfolksController"];
}
