...
//  No Comment © 2016年 it7090.com. All rights reserved.
...
-(void)setupLaunchAd
{
    ...
    if (self.imageAdConfiguration.viewController) {
        //添加launchImage
        [self.imageAdConfiguration.viewController.view addSubview:self.launchImageView];
    }else {
        //添加launchImage
...
-(void)startSkipDispathTimer
{
    ...
    dispatch_source_set_timer(_skipTimer, dispatch_walltime(NULL, 0.1), period * NSEC_PER_SEC, 0);
