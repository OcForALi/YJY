...
+ (instancetype)instanceWithStoryBoard {
    ...
    return (YJYInsureBonusController *)[UIStoryboard storyboardWithName:@"YJYInsureBonus" viewControllerIdentifier:NSStringFromClass(self)];
}
...
- (void)viewDidLoad {
    ...
    [self.headerView yjy_setTopShadow];
    //data
...
- (void)reloadAccountData {
    ...
    self.beServiceLabel.text = [NSString stringWithFormat:@"被服务人: %@",self.order.kinsName] ;
    
    
    self.leftMoneyLabel.text = self.order.paidFee;
