...
#import "UIApplication+KMMobileProvision.h"
#import "TargetConditionals.h"

@implementation UIApplication (KMMobileProvision)
...
-(UIApplicationReleaseMode) releaseMode {
	...
	} else if ([mobileProvision objectForKey:@"ProvisionedDevices"] && [(NSDictionary *)[mobileProvision objectForKey:@"ProvisionedDevices"] count] > 0) {
...
- (BOOL)isNotReleaseFromAppstore {
    return ([[UIApplication sharedApplication] releaseMode] != UIApplicationReleaseAppStore);
}
@end
