...
//  No Comment (c) 2014年 Ruifeng. All rights reserved.
//
...
+(NSDate *)dateString:(NSString *)dateString
{
    return  [NSDate dateString:dateString Format:YYYY_MM_DD_HH_MM_SS];
}
...
+ (NSInteger)weekdayInThisMonth:(NSDate *)date{
    ...
    NSInteger unitFlags =NSCalendarUnitYear | NSCalendarUnitMonth |NSCalendarUnitMonth | NSCalendarUnitWeekday |
...
- (BOOL)isAmTimeBucketWithDate:(NSDate *)currentDate {
